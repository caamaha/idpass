...
// 	echo "<br>";
// 	echo "Public Key:<br>";
// 	echo $_SESSION['publickey']['e'];
// 	echo "<br>";
// 	echo $_SESSION['publickey']['n'];
}
...
if($RELEASE)
{
	$conn = mysql_connect('bdm267573508.my3w.com', 'bdm267573508', 'waitforfairy');
	mysql_select_db('bdm267573508_db', $conn);
}
else
{
	$conn = mysql_connect('localhost', 'root', 'root');
	mysql_select_db('idpass', $conn);
}
//更改数据库编码
...
{
	$query = "select * from user_list where uid = '$uid'";
